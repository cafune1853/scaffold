...
public class ModuleGenerator {
	...
	private String getRawJavaPath() {
		return rawPath + "src" + File.separator + "main" + File.separator + "java" + File.separator + StringUtil.getPackagePath(RAW_GROUP_ID, rawArtifactId, File.separator) + File.separator;
	}
	...
	private String getRawTestJavaPath() {
		return rawPath + "src" + File.separator + "test" + File.separator + "java" + File.separator + StringUtil.getPackagePath(RAW_GROUP_ID, rawArtifactId, File.separator) + File.separator;
	}
